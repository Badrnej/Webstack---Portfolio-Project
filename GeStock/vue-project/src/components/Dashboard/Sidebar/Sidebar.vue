...
.sidebar :deep(a) {
  @apply transition-all duration-300 rounded-lg hover:bg-white/10 px-3 py-2 flex items-center space-x-3;
}

.sidebar :deep(svg) {
  @apply transition-all duration-300 w-5 h-5;
}

.sidebar :deep(a:hover svg) {
